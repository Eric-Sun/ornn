...
// 用户登录
const Login = params => {
  return __WEBPACK_IMPORTED_MODULE_0__instrance__["c" /* p */]('', params);
};
...
/* harmony default export */ __webpack_exports__["a"] = ([{
  ...
  children: [{ path: 'list', name: '帖子列表', meta: { alias: 'postList' }, component: postList }, { path: 'detail', name: '帖子列表', meta: { alias: 'postDetail' }, component: postDetail, hidden: true }, { path: 'replyDetail', name: '回复列表', meta: { alias: 'replyDetail' }, component: replyDetail, hidden: true
...
//# sourceMappingURL=app.8db90e4c466accd1edbc.js.map